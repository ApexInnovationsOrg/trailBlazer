    ...
    render(){
        let rowClasses = this.props.number === 0 ? "row" : "row mt-4";
            ...
            return <div className={rowClasses}>
                    <input name={this.props.number} onChange={(event)=>this.props.updateAnswer(event.target.value,this.props.number)} className="col-md-9 form-control input-md mt-1" placeholder="1:00pm" type="text"></input>
