...
export class PostNodeModel extends NodeModel {
	name: string;
	node: Object;
	question: Object;
	...
	addInPort(label: string): PostPortModel {
		return this.addPort(new PostPortModel(true,label));
	}

	addOutPort(label: string): PostPortModel {
		return this.addPort(new PostPortModel(false,label));
	}
}
