...
import { PostPortModel } from "./PostPortModel";
...
export interface PostNodeWidgetProps {
	node: PostNodeModel;
	size?: number;
	answer?:object;
}

export interface PostNodeWidgetState {
 ...
 */
class PostNodeWidgetClass extends React.Component<PostNodeWidgetProps, PostNodeWidgetState> {
	answer:object;
	editingAnswer:boolean;

	public static defaultProps: PostNodeWidgetProps = {
		size: 300,
		node: null
	};

	constructor(props: PostNodeWidgetProps) {
		super(props);
		this.state = {
			editingAnswer:false,
...
export type PostNodeWidget = PostNodeWidgetClass;

export default connect(mapStateToProps)(PostNodeWidgetClass);